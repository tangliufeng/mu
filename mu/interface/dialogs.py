...
#         widget_layout = QVBoxLayout()
#         self.setLayout(widget_layout)
#         self.minify = QCheckBox(("Minify Python code before flashing?"))
...
#             ("How to flash MicroPython to your device")
#         )
...
#         self.btnFolder = QPushButton(("Browse"))
#         self.btnExec = QPushButton(("Erase && write firmware"))
...
class AdminDialog(QDialog):
    ...
    def setup(self, log):
        ...
        # self.tabs.addTab(self.envar_widget, ("Python3 Environment"))
        ...
        # )
        # self.tabs.addTab(self.microbit_widget, ("BBC micro:bit Settings"))
        # self.package_widget = PackagesWidget()
        # self.package_widget.setup(packages)
        # self.tabs.addTab(self.package_widget, ("Third Party Packages"))
        # if mode.short_name == "esp":
        #     self.esp_widget = ESPFirmwareFlasherWidget()
        #     self.esp_widget.setup(mode, device_list)
        #     self.tabs.addTab(self.esp_widget, ("ESP Firmware flasher"))
...
class FindReplaceDialog(QDialog):
    ...
    * A flag to indicate if the user wishes to replace all.
    ...
    def setup(self, find=None, replace=None, replace_flag=False):
        ...
        # Replace
        replace_label = QLabel(("Replace (optional):"))
...
class PackageDialog(QDialog):
    ...
    def setup(self, to_remove, to_add, module_dir):
        ...
        # Basic layout.
        self.setMinimumSize(600, 400)
        self.setWindowTitle(("Third Party Package Status"))
        widget_layout = QVBoxLayout()
        self.setLayout(widget_layout)
